...
public class LiveFacialFeaturesView extends FrameView {
    ...
    public LiveFacialFeaturesView(SingleFrameApplication app) {
        ...
        try {
            int r = FSDK.ActivateLibrary("Sbo2lit1pS/5Cv0JPUtX4KMA5V2Ht6ihYLAaNBhjddpmPDHGxCNX9MmagkM23x0SMIrdOi/0K7Ln52p+leEzZR8WGBk1CABqN6fVxzORwL+ui3tnK2czF18q8ykYbz/rV1Lp3vaXnh+MJ6nfor/2i5nMDH8C8fs4tJ9dkFLeQTI=");
            if (r != FSDK.FSDKE_OK){
